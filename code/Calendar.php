...
<body>
     ...
     <script>
		function hid()
		{
		  ...
		  x.style.visibility="hidden";
		  var x=document.getElementById("apDiv15");
		  x.style.visibility="hidden";
		  ...
		  x.style.visibility="hidden";
		  var x=document.getElementById("apDiv18");
		  x.style.visibility="hidden";
		  var x=document.getElementById("apDiv19");
		  x.style.visibility="hidden";
     ...
     <div id="overlay">
       ...
       <div id="overlay_signup">
          ...
          <form class="signup" method="post" action="add.php">
            ...
            <div id="middlepart">
            	<iframe src="https://www.google.com/calendar/embed?showTitle=0&amp;showPrint=0&amp;height=800&amp;wkst=1&amp;bgcolor=%23990000&amp;src=tvkbibb149ub3lib968557eq1o%40group.calendar.google.com&amp;color=%23B1440E&amp;ctz=Asia%2FCalcutta" style=" border:solid 1px #777 " width="650" height="800" frameborder="0" scrolling="no"></iframe>
            </div>
